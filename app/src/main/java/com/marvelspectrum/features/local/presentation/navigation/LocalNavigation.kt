package com.marvelspectrum.features.local.presentation.navigation
...
import com.marvelspectrum.ui.theme.MusicDimensions
...
import com.marvelspectrum.shared.presentation.components.bottomsheets.SongPickerBottomSheet
import com.marvelspectrum.shared.presentation.components.common.CollapsibleHeaderScreen
import com.marvelspectrum.shared.presentation.components.common.ExpressiveFilledIconButton
...
import com.marvelspectrum.ui.LocalMiniPlayerPadding
import com.marvelspectrum.ui.UiConstants
...
import com.marvelspectrum.shared.presentation.components.bottomsheets.AddToPlaylistBottomSheet
import com.marvelspectrum.shared.presentation.components.bottomsheets.AlbumBottomSheet
import com.marvelspectrum.shared.presentation.components.bottomsheets.ArtistBottomSheet
import com.marvelspectrum.shared.presentation.components.bottomsheets.SongInfoBottomSheet
...
import com.marvelspectrum.features.local.presentation.screens.AddToPlaylistScreen
import com.marvelspectrum.shared.presentation.components.dialogs.CreatePlaylistDialog
import com.marvelspectrum.shared.presentation.components.dialogs.QueueActionDialog
import com.marvelspectrum.shared.presentation.components.dialogs.QueueListActionDialog
import com.marvelspectrum.shared.presentation.components.player.MiniPlayer
import com.marvelspectrum.shared.presentation.components.player.SleepTimerBottomSheetNew
import com.marvelspectrum.features.local.presentation.screens.LibraryScreen
import com.marvelspectrum.features.local.presentation.screens.HomeScreen
import com.marvelspectrum.shared.presentation.screens.RhythmStatsScreen
import com.marvelspectrum.features.local.presentation.screens.EqualizerScreen
import com.marvelspectrum.shared.presentation.screens.player.PlayerScreen

import com.marvelspectrum.features.local.presentation.screens.PlaylistDetailScreen
import com.marvelspectrum.features.local.presentation.screens.ArtistDetailScreen
import com.marvelspectrum.shared.presentation.screens.settings.SettingsScreenWrapper
import com.marvelspectrum.shared.presentation.screens.settings.*
import com.marvelspectrum.shared.data.model.PlaybackLocation
import com.marvelspectrum.shared.presentation.components.MediaScanLoader // Add MediaScanLoader import
import com.marvelspectrum.util.ArtistSeparator
...
import com.marvelspectrum.features.local.presentation.screens.LibraryTab
...
import com.marvelspectrum.shared.presentation.screens.viewing.ViewingDetailScreen
import com.marvelspectrum.shared.presentation.screens.viewing.ViewingHomeScreen
import com.marvelspectrum.shared.presentation.screens.viewing.ViewingLibraryScreen
import com.marvelspectrum.shared.presentation.screens.viewing.ViewingSearchScreen
...
fun LocalNavigation(
    ...
    val onPlaySong = { song: com.marvelspectrum.shared.data.model.Song -> viewModel.playSong(song) }
    val onPlayAlbum = { album: com.marvelspectrum.shared.data.model.Album -> viewModel.playAlbum(album) }
    val onPlayAlbumShuffled = { album: com.marvelspectrum.shared.data.model.Album -> viewModel.playAlbumShuffled(album) }
    val onPlayArtist = { artist: com.marvelspectrum.shared.data.model.Artist -> viewModel.playArtist(artist) }
    val onPlayPlaylist =
        { playlist: com.marvelspectrum.shared.data.model.Playlist -> viewModel.playPlaylist(playlist) }
    val onPlayPlaylistShuffled = { playlist: com.marvelspectrum.shared.data.model.Playlist -> viewModel.playPlaylistShuffled(playlist) }
...
private fun LocalNavigationContent(
    ...
    songs: List<com.marvelspectrum.shared.data.model.Song>,
    allSongs: List<com.marvelspectrum.shared.data.model.Song>,
    albums: List<com.marvelspectrum.shared.data.model.Album>,
    artists: List<com.marvelspectrum.shared.data.model.Artist>,
    playlists: List<com.marvelspectrum.shared.data.model.Playlist>,
    ...
    lyrics: com.marvelspectrum.shared.data.model.LyricsData?,
    isLoadingLyrics: Boolean,
    recentlyPlayed: List<com.marvelspectrum.shared.data.model.Song>,
    ...
    onPlaySong: (com.marvelspectrum.shared.data.model.Song) -> Unit,
    onPlayAlbum: (com.marvelspectrum.shared.data.model.Album) -> Unit,
    onPlayAlbumShuffled: (com.marvelspectrum.shared.data.model.Album) -> Unit,
    onPlayArtist: (com.marvelspectrum.shared.data.model.Artist) -> Unit,
    onPlayPlaylist: (com.marvelspectrum.shared.data.model.Playlist) -> Unit,
    onPlayPlaylistShuffled: (com.marvelspectrum.shared.data.model.Playlist) -> Unit,
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            NavHost(
                ...
                composable(
                    ...
                    var selectedSongForPlaylist by remember { mutableStateOf<com.marvelspectrum.shared.data.model.Song?>(null) }
                    var showSongInfoSheet by remember { mutableStateOf(false) }
                    var selectedSongForInfo by remember { mutableStateOf<com.marvelspectrum.shared.data.model.Song?>(null) }
                    ...
                    com.marvelspectrum.shared.presentation.screens.UniversalSearchScreen(
                ...
                composable(Screen.TunerAbout.route) {
                    com.marvelspectrum.shared.presentation.screens.settings.AboutScreen(
                ...
                composable(
                    ...
                    var selectedSongForInfo by remember { mutableStateOf<com.marvelspectrum.shared.data.model.Song?>(null) }
                    var showAlbumBottomSheet by remember { mutableStateOf(false) }
                    var selectedAlbum by remember { mutableStateOf<com.marvelspectrum.shared.data.model.Album?>(null) }
                    val albumBottomSheetState = rememberModalBottomSheetState(skipPartiallyExpanded = false)
...
@Composable
private fun DisabledViewingSettingsPanel(
    title: String,
    message: String,
    onBackClick: () -> Unit
) {
        ...
        Box(
            ...
            Surface(
                ...
                Column(
                    ...
                    Button(onClick = onBackClick) { Text("Back to settings") }
                }
            }
        }
    }
