package com.marvelspectrum.features.streaming.presentation.navigation
...
import com.marvelspectrum.shared.presentation.screens.settings.RhythmGuardSettingsScreen
import com.marvelspectrum.shared.presentation.screens.settings.QueueSettingsScreen
import com.marvelspectrum.shared.presentation.screens.settings.PlaybackSettingsScreen
import com.marvelspectrum.features.local.presentation.viewmodel.MusicViewModel as LocalMusicViewModel
import com.marvelspectrum.features.streaming.domain.model.StreamingArtist
import com.marvelspectrum.features.streaming.domain.model.StreamingAlbum
import com.marvelspectrum.features.streaming.domain.model.StreamingPlaylist
import com.marvelspectrum.features.streaming.domain.model.StreamingSong
import com.marvelspectrum.features.streaming.presentation.screens.StreamingContentHomeScreen
import com.marvelspectrum.features.streaming.presentation.screens.StreamingHomeScreen
import com.marvelspectrum.features.streaming.presentation.screens.StreamingLibraryScreen
import com.marvelspectrum.features.streaming.presentation.screens.StreamingServiceSetupScreen
import com.marvelspectrum.features.streaming.presentation.screens.GoSettingsScreen
import com.marvelspectrum.features.streaming.presentation.screens.toLibraryAlbum
import com.marvelspectrum.features.streaming.presentation.screens.toLibraryPlaylist
    ...
    fun StreamingNavigationLayout(contentModifier: Modifier, showBottomNavValue: Boolean) {
        ...
        NavHost(
            ...
            composable(
                ...
                var selectedAlbumForSheet by remember { mutableStateOf<com.marvelspectrum.features.streaming.domain.model.StreamingAlbum?>(null) }
            ...
            composable(
                ...
                if (showCreatePlaylistDialog) {
                    com.marvelspectrum.shared.presentation.components.dialogs.CreatePlaylistDialog(
