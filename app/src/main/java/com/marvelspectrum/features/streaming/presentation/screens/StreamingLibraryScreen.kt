...
import com.marvelspectrum.features.local.presentation.screens.SingleCardAlbumsContent
import com.marvelspectrum.features.local.presentation.screens.SingleCardArtistsContent
import com.marvelspectrum.features.local.presentation.screens.PlaylistFabMenu
import com.marvelspectrum.features.local.presentation.screens.SingleCardPlaylistsContent
import com.marvelspectrum.features.local.presentation.screens.SingleCardSongsContent
...
private enum class StreamingLibraryTab(@param:StringRes val titleRes: Int, val icon: com.marvelspectrum.shared.presentation.components.icons.MaterialSymbolIcon) {
...
private enum class StreamingSongSortOrder(
    ...
    val icon: com.marvelspectrum.shared.presentation.components.icons.MaterialSymbolIcon
) {
                                            ...
                                            DropdownMenuItem(
                                                ...
                                                leadingIcon = {
                                                    Surface(
                                                        ...
                                                        Icon(
                                                            imageVector = com.marvelspectrum.shared.presentation.components.icons.RhythmIcons.AddToPlaylist,
                                                            contentDescription = null,
...
fun StreamingAlbum.toLibraryAlbum(librarySongs: List<com.marvelspectrum.shared.data.model.Song>): Album {
