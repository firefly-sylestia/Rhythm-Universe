package com.marvelspectrum.features.streaming.data.repository
...
import com.marvelspectrum.core.domain.model.PlaylistItem
import com.marvelspectrum.core.domain.model.SourceType
import com.marvelspectrum.core.utils.NetworkUtils
import com.marvelspectrum.features.streaming.data.provider.JellyfinApiClient
import com.marvelspectrum.features.streaming.data.provider.ProviderConnectionResult
import com.marvelspectrum.features.streaming.data.provider.ProviderAlbum
import com.marvelspectrum.features.streaming.data.provider.ProviderArtist
import com.marvelspectrum.features.streaming.data.provider.ProviderPlaylist
import com.marvelspectrum.features.streaming.data.provider.ProviderSong
import com.marvelspectrum.features.streaming.data.provider.SubsonicApiClient
import com.marvelspectrum.features.streaming.domain.model.BrowseCategory
...
import com.marvelspectrum.features.streaming.domain.model.StreamingServiceId
import com.marvelspectrum.features.streaming.domain.model.StreamingSong
import com.marvelspectrum.features.streaming.domain.repository.StreamingMusicRepository
...
class StreamingMusicRepositoryImpl(
    ...
    private fun mapProviderPlaylist(
        ...
        return StreamingPlaylist(
            ...
            owner = if (providerPlaylist.owner != null) {
                com.marvelspectrum.features.streaming.domain.model.PlaylistOwner(
    ...
    private fun mapProviderAlbum(serviceId: String, providerAlbum: ProviderAlbum): StreamingAlbum {
        return StreamingAlbum(
            ...
            releaseDate = null,
            albumType = com.marvelspectrum.features.streaming.domain.model.AlbumType.ALBUM,
            genres = emptyList(),
            label = null,
            copyright = null,
            isExplicit = false
