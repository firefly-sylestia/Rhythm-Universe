...
import com.marvelspectrum.core.domain.model.StreamingQuality
...
import com.marvelspectrum.core.utils.NetworkUtils
import com.marvelspectrum.shared.presentation.components.bottomsheets.StandardBottomSheetHeader
import androidx.compose.ui.text.style.TextOverflow
import com.marvelspectrum.features.streaming.presentation.model.StreamingServiceOption
...
fun GoSettingsScreen(
    ...
    pendingServiceSelection?.let { pendingId ->
        androidx.compose.material3.AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(id = com.marvelspectrum.R.string.streaming_settings_switch_provider_confirm_title),
            ...
            text = {
                ...
                Text(
                    text = stringResource(id = com.marvelspectrum.R.string.streaming_settings_switch_provider_confirm_desc, currentLabel, pendingLabel),
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    Text(text = stringResource(id = com.marvelspectrum.R.string.action_switch))
                }
            },
            dismissButton = {
                OutlinedButton(onClick = { pendingServiceSelection = null }) {
                    Text(text = stringResource(id = com.marvelspectrum.R.string.action_cancel))
                }
            }
        )
    }
...
private fun StreamingStatusCard(
    ...
    val badgeText = when {
        isLoading -> stringResource(id = com.marvelspectrum.R.string.streaming_status_badge_refreshing)
        isConnected -> stringResource(id = com.marvelspectrum.R.string.streaming_status_badge_connected)
        else -> stringResource(id = com.marvelspectrum.R.string.streaming_status_badge_pending)
    }
    ...
    Card(
        ...
        Column(
            ...
            if (isConnected) {
                ...
                Text(
                    text = stringResource(id = com.marvelspectrum.R.string.streaming_status_connect_hint),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onPrimaryContainer.copy(alpha = 0.9f)
                )
            }
...
private fun ServiceSelectionBottomSheet(
    ...
    sessions: Map<String, com.marvelspectrum.features.streaming.data.repository.StreamingServiceSession>,
    onDismiss: () -> Unit,
    ...
    ModalBottomSheet(
        ...
        StandardBottomSheetHeader(
            title = stringResource(id = com.marvelspectrum.R.string.streaming_settings_preferred_service),
            subtitle = stringResource(id = com.marvelspectrum.R.string.streaming_settings_service_sheet_desc),
            visible = true
        )
        Column(
            modifier = Modifier
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                text = if (isConnected) {
                                    stringResource(id = com.marvelspectrum.R.string.streaming_status_connected)
                                } else {
                                    stringResource(id = com.marvelspectrum.R.string.streaming_status_not_connected)
                                },
                                style = MaterialTheme.typography.bodySmall,
                                color = if (isSelected) {
...
private fun QualitySelectionBottomSheet(
    ...
    ModalBottomSheet(
        ...
        StandardBottomSheetHeader(
            title = stringResource(id = com.marvelspectrum.R.string.streaming_settings_quality),
            subtitle = stringResource(id = com.marvelspectrum.R.string.streaming_settings_quality_sheet_desc),
            visible = true
        )
        Column(
            modifier = Modifier
            ...
            val streamingQualityOptions = listOf(
                Pair("LOW", com.marvelspectrum.R.string.streaming_quality_low),
                Pair("NORMAL", com.marvelspectrum.R.string.streaming_quality_normal),
                Pair("HIGH", com.marvelspectrum.R.string.streaming_quality_high),
                Pair("LOSSLESS", com.marvelspectrum.R.string.streaming_quality_lossless)
            )
...
private fun selectedServiceLabel(selectedService: String, context: Context): String {
    ...
    return matching?.let { context.getString(it.nameRes) } ?: context.getString(com.marvelspectrum.R.string.streaming_not_selected)
}
