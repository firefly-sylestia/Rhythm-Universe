...
object ExpressiveShapeProvider {
    ...
    fun getShapeById(shapeId: String, fallback: Shape = CircleShape): Shape {
        val roundedPolygon = com.marvelspectrum.shared.presentation.components.common.getShapeById(shapeId)
    ...
    fun isValidShapeId(shapeId: String): Boolean {
        return com.marvelspectrum.shared.presentation.components.common.getShapeById(shapeId) != null
    }
