...
import com.marvelspectrum.shared.presentation.navigation.RhythmGuardRiskLevel
import com.marvelspectrum.shared.presentation.navigation.rhythmGuardResolveRiskLevel
...
fun SettingsTipsRow(
    ...
    LaunchedEffect(limitMinutes, manualVolumeFloat) {
        val statsRepo = com.marvelspectrum.shared.data.repository.PlaybackStatsRepository.getInstance(context)
        val audioManager = context.getSystemService(android.content.Context.AUDIO_SERVICE) as android.media.AudioManager
        
        while (true) {
            val stats = statsRepo.loadSummary(com.marvelspectrum.shared.data.repository.StatsTimeRange.TODAY)
            ...
            currentRiskLevel = com.marvelspectrum.shared.presentation.navigation.rhythmGuardResolveRiskLevel(
...
@Composable
private fun DisabledViewingSettingsRoute(
    title: String,
    message: String,
    onBackClick: () -> Unit
) {
