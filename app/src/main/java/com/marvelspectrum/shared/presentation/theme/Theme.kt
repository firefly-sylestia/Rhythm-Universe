package com.marvelspectrum.ui.theme
...
import com.marvelspectrum.util.ColorExtractor
import com.marvelspectrum.util.ExtractedColors
...
fun getAlbumArtColorScheme(colorsJson: String, darkTheme: Boolean): androidx.compose.material3.ColorScheme {
    val extractedColors = com.marvelspectrum.util.ColorExtractor.jsonToColors(colorsJson)
