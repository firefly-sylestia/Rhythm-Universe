package com.marvelspectrum.activities
...
import com.marvelspectrum.shared.presentation.navigation.RhythmNavigation
import com.marvelspectrum.ui.theme.RhythmTheme
import com.marvelspectrum.ui.theme.festive.FestiveOverlayFromSettings
...
import com.marvelspectrum.util.CrashReporter // Import CrashReporter
...
//import com.marvelspectrum.ui.annotations.RhythmAnimation
...
import androidx.compose.animation.core.tween
import com.marvelspectrum.shared.data.model.AppSettings // Import AppSettings
import java.util.Locale // Import Locale
import androidx.compose.material3.DropdownMenu
import androidx.compose.material3.DropdownMenuItem
import androidx.compose.runtime.rememberCoroutineScope
import com.marvelspectrum.shared.presentation.components.common.M3LinearLoader // Import M3LinearLoader
import com.marvelspectrum.shared.presentation.components.common.M3FourColorCircularLoader // Import M3FourColorCircularLoader
...
import com.marvelspectrum.features.local.presentation.screens.SplashScreen
import com.marvelspectrum.shared.presentation.components.PermissionHandler
import com.marvelspectrum.shared.presentation.components.dialogs.BetaProgramPopup
import com.marvelspectrum.features.local.presentation.screens.OnboardingScreen
import com.marvelspectrum.features.local.presentation.screens.onboarding.OnboardingStep
import com.marvelspectrum.features.local.presentation.screens.onboarding.PermissionScreenState
...
class MainActivity : FragmentActivity() {
    ...
    private suspend fun startMediaServiceAndWait(): Boolean {
        return try {
            val serviceIntent = Intent(this, com.marvelspectrum.infrastructure.service.MediaPlaybackService::class.java)
            serviceIntent.action = com.marvelspectrum.infrastructure.service.MediaPlaybackService.ACTION_INIT_SERVICE
    ...
    private suspend fun fallbackPlayExternalFile(uri: Uri) {
        try {
            ...
            val playIntent = Intent(applicationContext, com.marvelspectrum.infrastructure.service.MediaPlaybackService::class.java)
            playIntent.action = com.marvelspectrum.infrastructure.service.MediaPlaybackService.ACTION_PLAY_EXTERNAL_FILE
            playIntent.data = uri
