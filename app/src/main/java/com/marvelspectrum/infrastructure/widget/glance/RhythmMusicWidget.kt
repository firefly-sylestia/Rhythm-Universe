...
class RhythmMusicWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val appSettings = try {
            com.marvelspectrum.shared.data.model.AppSettings.getInstance(context)
        } catch (e: Exception) {
            null
        }
    ...
    private fun getWidgetData(prefs: Preferences, appSettings: com.marvelspectrum.shared.data.model.AppSettings?): WidgetData {
        return try {
            WidgetData(
