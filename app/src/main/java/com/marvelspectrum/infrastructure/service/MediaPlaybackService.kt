package com.marvelspectrum.infrastructure.service
...
import com.marvelspectrum.shared.data.model.TransitionSettings
import com.marvelspectrum.shared.data.model.TransitionMode
...
import com.marvelspectrum.infrastructure.service.player.RhythmPlayerEngine
import com.marvelspectrum.infrastructure.service.player.TransitionController
import com.marvelspectrum.infrastructure.service.player.PreloadController
import com.marvelspectrum.infrastructure.widget.WidgetUpdater
...
import com.marvelspectrum.shared.presentation.screens.settings.rhythmGuardFormatDurationFromMinutes
import com.marvelspectrum.activities.RhythmGuardTimeoutActivity
...
class MediaPlaybackService : MediaLibraryService(), Player.Listener {
    ...
    private var rhythmBassBoostProcessor: com.marvelspectrum.infrastructure.audio.RhythmBassBoostProcessor? = null
    private var rhythmSpatializationProcessor: com.marvelspectrum.infrastructure.audio.RhythmSpatializationProcessor? = null
    ...
    private val favoriteChangeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                "com.marvelspectrum.action.FAVORITE_CHANGED" -> {
    ...
    private lateinit var scrobblerManager: com.marvelspectrum.utils.ScrobblerManager
    
    // Discord Rich Presence manager
    private lateinit var discordRichPresenceManager: com.marvelspectrum.utils.DiscordRichPresenceManager
    
    // Status broadcaster for Tasker, KWGT, and other automation apps
    private lateinit var statusBroadcaster: com.marvelspectrum.utils.StatusBroadcaster
    ...
    companion object {
        ...
        const val ACTION_UPDATE_SETTINGS = "com.marvelspectrum.action.UPDATE_SETTINGS"
        
        // Intent action for playing external files
        const val ACTION_PLAY_EXTERNAL_FILE = "com.marvelspectrum.action.PLAY_EXTERNAL_FILE"
        
        // Intent action for initializing the service
        const val ACTION_INIT_SERVICE = "com.marvelspectrum.action.INIT_SERVICE"
        
        // Intent actions for sleep timer
        const val ACTION_START_SLEEP_TIMER = "com.marvelspectrum.action.START_SLEEP_TIMER"
        const val ACTION_STOP_SLEEP_TIMER = "com.marvelspectrum.action.STOP_SLEEP_TIMER"
        
        // Intent actions for equalizer
        const val ACTION_SET_EQUALIZER_ENABLED = "com.marvelspectrum.action.SET_EQUALIZER_ENABLED"
        const val ACTION_SET_EQUALIZER_BAND = "com.marvelspectrum.action.SET_EQUALIZER_BAND"
        const val ACTION_SET_BASS_BOOST = "com.marvelspectrum.action.SET_BASS_BOOST"
        const val ACTION_SET_VIRTUALIZER = "com.marvelspectrum.action.SET_VIRTUALIZER"
        const val ACTION_APPLY_EQUALIZER_PRESET = "com.marvelspectrum.action.APPLY_EQUALIZER_PRESET"
        const val ACTION_GET_EQUALIZER_DIAGNOSTICS = "com.marvelspectrum.action.GET_EQUALIZER_DIAGNOSTICS"
        
        // Widget control actions
        const val ACTION_PLAY_PAUSE = "com.marvelspectrum.action.PLAY_PAUSE"
        const val ACTION_SKIP_NEXT = "com.marvelspectrum.action.SKIP_NEXT"
        const val ACTION_SKIP_PREVIOUS = "com.marvelspectrum.action.SKIP_PREVIOUS"
        const val ACTION_TOGGLE_FAVORITE = "com.marvelspectrum.action.TOGGLE_FAVORITE"
        
        // Broadcast actions for status updates
        const val BROADCAST_SLEEP_TIMER_STATUS = "com.marvelspectrum.broadcast.SLEEP_TIMER_STATUS"
        ...
        const val ACTION_SHUFFLE_STATE_CHANGED = "com.marvelspectrum.action.SHUFFLE_STATE_CHANGED"
        const val EXTRA_SHUFFLE_ENABLED = "shuffle_enabled"
        
        // Audio session ID
        const val ACTION_GET_AUDIO_SESSION_ID = "com.marvelspectrum.action.GET_AUDIO_SESSION_ID"
        const val BROADCAST_AUDIO_SESSION_ID = "com.marvelspectrum.broadcast.AUDIO_SESSION_ID"
        const val EXTRA_AUDIO_SESSION_ID = "audio_session_id"
        
        // Mute/Unmute actions (Media3 1.9.0 feature)
        const val ACTION_MUTE = "com.marvelspectrum.action.MUTE"
        const val ACTION_UNMUTE = "com.marvelspectrum.action.UNMUTE"
        const val ACTION_TOGGLE_MUTE = "com.marvelspectrum.action.TOGGLE_MUTE"
        ...
        private const val METADATA_EXTRA_ORIGINAL_TITLE = "com.marvelspectrum.extra.original_title"
        private const val METADATA_EXTRA_ORIGINAL_ARTIST = "com.marvelspectrum.extra.original_artist"
        private const val METADATA_EXTRA_ORIGINAL_ALBUM = "com.marvelspectrum.extra.original_album"
    }
    ...
    override fun onCreate() {
        ...
        startForegroundWithNotification(
            getString(com.marvelspectrum.R.string.service_rhythm_music),
            getString(com.marvelspectrum.R.string.service_starting)
        )

        // Initialize settings manager (fast operation)
        updateForegroundNotification(
            getString(com.marvelspectrum.R.string.service_rhythm_music),
            getString(com.marvelspectrum.R.string.service_loading_settings)
        )
        ...
        try {
            rhythmBassBoostProcessor = com.marvelspectrum.infrastructure.audio.RhythmBassBoostProcessor()
            rhythmSpatializationProcessor = com.marvelspectrum.infrastructure.audio.RhythmSpatializationProcessor()
        ...
        scrobblerManager = com.marvelspectrum.utils.ScrobblerManager(applicationContext)
        
        // Initialize Discord Rich Presence manager
        discordRichPresenceManager = com.marvelspectrum.utils.DiscordRichPresenceManager(applicationContext)
        
        // Initialize status broadcaster for Tasker/KWGT
        statusBroadcaster = com.marvelspectrum.utils.StatusBroadcaster(applicationContext)

        // Register BroadcastReceiver for favorite changes
        updateForegroundNotification(
            getString(com.marvelspectrum.R.string.service_rhythm_music),
            getString(com.marvelspectrum.R.string.service_setup_components)
        )
        val filter = IntentFilter("com.marvelspectrum.action.FAVORITE_CHANGED")
        ...
        try {
            ...
            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_initializing_player)
            )
            initializePlayer()

            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_creating_controls)
            )
            ...
            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_setup_media_session)
            )
            ...
            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_initializing_controller)
            )
            createController()
                            ...
                            if (timeoutUntil > 0L && now >= timeoutUntil && cooldownUntil <= 0L) {
                                ...
                                if (currentMinutes > activeLimit) {
                                    ...
                                    val timeoutReason = getString(
                                        com.marvelspectrum.R.string.settings_rhythm_guard_timeout_reason_auto,
                                        formattedToday,
                                        formattedLimit
                                    )
            ...
            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_ready)
            )
            ...
            updateForegroundNotification(
                getString(com.marvelspectrum.R.string.service_rhythm_music),
                getString(com.marvelspectrum.R.string.service_init_failed)
            )
        }
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                CHANNEL_ID,
                getString(com.marvelspectrum.R.string.media3_notification_channel_name),
                NotificationManager.IMPORTANCE_LOW
            ).apply {
                description = getString(com.marvelspectrum.R.string.media3_notification_channel_description)
                setShowBadge(false)
            }

            val sleepTimerChannel = NotificationChannel(
                SLEEP_TIMER_CHANNEL_ID,
                getString(com.marvelspectrum.R.string.notification_sleep_timer_channel_name),
                NotificationManager.IMPORTANCE_DEFAULT
            ).apply {
                description = getString(com.marvelspectrum.R.string.notification_sleep_timer_channel_desc)
                setShowBadge(false)
    ...
    private fun startForegroundWithNotification(title: String = "Marvel Spectrum", content: String = "Marvel Spectrum is starting.") {
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle(title)
            .setContentText(content)
            .setSmallIcon(com.marvelspectrum.R.drawable.ic_notification)
            .setOngoing(true)
    ...
    private fun createCustomCommands() {
        customCommands = listOf(
            ...
            createCustomIconButton(
                "Add to favorites",
                FAVORITE_ON,
                com.marvelspectrum.R.drawable.ic_favorite_border
            ),
            createCustomIconButton(
                "Remove from favorites",
                FAVORITE_OFF,
                com.marvelspectrum.R.drawable.ic_favorite_filled
            )
        )
    }
    ...
    private fun toggleCurrentSongFavorite() {
        ...
        if (songId != null) {
            try {
                ...
                val notifyIntent = Intent("com.marvelspectrum.action.FAVORITE_CHANGED")
        ...
        serviceScope.launch {
            try {
                ...
                val mediaItem = withContext(Dispatchers.IO) {
                    try {
                        val song = com.marvelspectrum.util.MediaUtils.extractMetadataFromUri(this@MediaPlaybackService, uri)
    ...
    private inner class MediaSessionCallback : MediaLibrarySession.Callback {
        ...
        override fun onGetLibraryRoot(
            ...
            val rootItem = MediaItem.Builder()
                ...
                .setMediaMetadata(
                    MediaMetadata.Builder()
                        .setTitle("Marvel Spectrum Library")
    ...
    private fun updateSleepTimerProgressNotification(
        ...
        val title = getString(com.marvelspectrum.R.string.notification_sleep_timer_title)
        val timeText = formatSleepTimerDuration(remainingMs)
        val content = if (pauseOnly) {
            getString(com.marvelspectrum.R.string.notification_sleep_timer_pause_in, timeText)
        } else {
            getString(com.marvelspectrum.R.string.notification_sleep_timer_stop_in, timeText)
        }
